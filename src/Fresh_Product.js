...
function Fresh_Product() {
    ...
    const Fresh_Product_Items = all_items.map((item,index)=>{
        if(item.category==="Fresh Product")
        {
            return <Product 
                   key={index}
                   id={item.id}
    ...
    return (
        <div>
            <div className="bakery">
                <ScrollToTop 
                    color='whitesmoke'
                    style={{background:'#4caf50',borderRadius:'50%',padding:'5px',border:"2px solid green" , boxShadow: "2px 0px 6px 1px green" }}
                    smooth/>
                ...
                <div data-aos="fade-right" className="bakery__right">                    
                    {
                        ...
                        <>
                            ...
                            <h3 data-aos="fade-right">Fresh Products</h3>
                            </div>
                            {
                                Fresh_Product_Items
                            }                        
