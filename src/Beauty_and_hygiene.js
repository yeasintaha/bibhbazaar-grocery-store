...
function Beauty_and_hygiene() {
    const Beauty_hygiene_Items = all_items.map((item,index)=>{
        if(item.category==="Beauty and Hygiene")
        {
            return <Product 
                   key={index}
                   id={item.id}
                ...
                <div data-aos="fade-right" className="bakery__right">                    
                    {
                        ...
                        <>
                            ...
                            <h3 data-aos="fade-right">Beauty and Hygiene</h3>
                            </div>
                            {
                                Beauty_hygiene_Items
                            }  
                            {/* <br/><br/> <br/> <br/> <br/> <br/> */}
                        </>
                    }
...
export default Beauty_and_hygiene;
