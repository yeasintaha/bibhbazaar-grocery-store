...
function Biscuits_Cakes() {
    const Biscuits_Items = all_items.map((item,index)=>{
        if(item.category === "Biscuits_Cakes")
        {
            return <Product 
                   key={index}
                   id={item.id}
                ...
                <div data-aos="fade-right" className="bakery__right">                    
                    {
                        ...
                        <>
                            ...
                            <h3 data-aos="fade-right">Biscuits and Cakes</h3>
                            </div>
                            {
                                Biscuits_Items
                            }  
